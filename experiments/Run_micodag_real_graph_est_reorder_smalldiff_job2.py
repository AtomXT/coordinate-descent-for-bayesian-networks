...
if __name__ == '__main__':
    ...
    for dataset in ['9insurance', '10factors']:
        for kk in range(1, 11):
            ...
            print(df)
            result_file = os.path.join(current_dir, "../experiment results/comparison with benchmarks/micodag_est_12log(m)n_small_diff_job2.csv")
