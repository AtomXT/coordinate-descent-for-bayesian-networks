...
if __name__ == '__main__':
    ...
    for dataset in ['1dsep', '2asia', '3bowling', '5rain', '6cloud', '7funnel', '8galaxy']:
        ...
        print(df)
        result_file = os.path.join(current_dir, "../experiment results/comparison with benchmarks/micodag_est_12log(m)n_small_diff_job1_small_lam.csv")
