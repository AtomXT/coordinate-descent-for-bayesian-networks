...
wd = getwd()
dataset.folder <- paste0(wd,"/Data/SyntheticDatasets_obj")
graphs <- c("graph1", "graph2", "graph3")
n_samples <- c(50, 100, 200, 300, 400, 500, 800, 1000, 1600, 3200)
...
write.csv(results, "./experiment results/synthetic_results_ges_small_alpha.csv",row.names=FALSE)