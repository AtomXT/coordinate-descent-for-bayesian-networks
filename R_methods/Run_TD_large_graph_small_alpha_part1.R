...
datasets <- c('14munin')
nsamples <- c('13pathfinder'=5450, '14munin'=9300, '15andes'=11150, '16diabetes'=20650)
...
write.csv(results, "./experiment results/comparison on large graphs/TD_large_graph_est_small_diff_part1.csv",row.names=FALSE)
